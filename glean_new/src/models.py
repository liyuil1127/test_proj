...
from aggregators_bak_20210401 import *
from utils import *
from modules import *
import time
import math
...
class glean_event(nn.Module):
    ...
    def evaluate(self, t, true_prob_r, time_triples, thread, is_use_th):
        ...
        for sub_idx in nonzero_rel_idx:
            if prob_rel[sub_idx] <= thread and is_use_th == 1:
                continue
