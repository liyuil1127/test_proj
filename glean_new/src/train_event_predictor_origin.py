...
parser.add_argument('--run_times', type=int, default=3, help='')
parser.add_argument('--epoch', type=int, default=50, help='')
parser.add_argument('--city_num', type=int, default=849, help='')
parser.add_argument('--group_num', type=int, default=10, help='')
parser.add_argument('--gnn_h', type=int, default=300, help='')
parser.add_argument('--gnn_layer', type=int, default=1, help='')
...
while iterations < args.runs:
    ...
    if iterations == 1:
        ...
        valid_loader = DataLoader(valid_dataset_loader, batch_size=4,
                                shuffle=False, collate_fn=collate_4)
        test_loader = DataLoader(test_dataset_loader, batch_size=4,
                                shuffle=False, collate_fn=collate_4)
    ...
    def evaluate(data_loader, dataset_loader, set_name='valid'):
        ...
        for i, batch in enumerate(tqdm(data_loader)):
            ...
            true_rank, prob_rank, loss, ranks = model.evaluate(batch_data, true_r)
